...
let greedy_is_good_tests = [
 ("hw5programs/easyrun1.oat", "", "17");
 ("hw5programs/easyrun2.oat", "", "35");
 ("hw5programs/easyrun5.oat", "", "212");
 ("hw5programs/easyrun6.oat", "", "9");
 ("hw5programs/easyrun7.oat", "", "23");
 ("hw5programs/easyrun8.oat", "", "160");
 ("hw5programs/path1.oat", "", "17");
 ("hw5programs/run26.oat", "", "0");
 ("hw5programs/run27.oat", "", "99");
 ("hw5programs/run29.oat", "", "1");
 ("hw5programs/run30.oat", "", "9");
 ("hw5programs/run31.oat", "", "9");
 ("hw5programs/run13.oat", "", "1");
 ("hw5programs/run38.oat", "", "31");
 ("hw5programs/run40.oat", "", "8");
 ("hw5programs/run60.oat", "", "85");
 ("hw5programs/heap.oat", "", "1");
 ("hw7programs/ifq2.oat", "", "5");
 ("hw7programs/length1.oat", "", "5");
 ("hw5programs/lcs.oat", "", "OAT0");
]


let hw5_easiest_tests = [
  ("hw5programs/easyrun3.oat", "", "73");
  ("hw5programs/easyrun4.oat", "", "6");
  ("hw5programs/easyrun9.oat", "", "236");
]

(* Should not be used for quality tests *)
let hw5_globals_tests = [
  ("hw5programs/globals1.oat", "", "42");
  ("hw5programs/globals2.oat", "", "17");
  ("hw5programs/globals3.oat", "", "17");
  ("hw5programs/globals4.oat", "", "5");
  ("hw5programs/globals5.oat", "", "17");
  ("hw5programs/globals6.oat", "", "15");
]

let hw5_path_tests = [
 ("hw5programs/path2.oat", "", "35");
 ("hw5programs/path3.oat", "", "3");
 ("hw5programs/arrayargs1.oat", "", "17");
 ("hw5programs/arrayargs2.oat", "", "17");
 ("hw5programs/arrayargs4.oat", "", "0"); 
]

let hw5_easy_tests = [
    ("hw5programs/run28.oat", "", "18");
    ("hw5programs/run32.oat", "", "33");
    ("hw5programs/run21.oat", "", "99");
    ("hw5programs/run33.oat", "", "1");
    ("hw5programs/run34.oat", "", "66");
    ("hw5programs/run39.oat", "a", "2");
    ("hw5programs/run42.oat", "", "2");
    ("hw5programs/run49.oat", "", "abc0");
    ("hw5programs/run50.oat", "", "abcde0");
    ("hw5programs/run61.oat", "", "3410");
]

let hw5_medium_tests = [
  ("hw5programs/fact.oat", "", "factorial(5) =1200");
  ("hw5programs/run1.oat", "", "153");
  ("hw5programs/run2.oat", "", "6");
  ("hw5programs/run8.oat", "", "2");
  ("hw5programs/run9.oat", "", "4");
  ("hw5programs/run10.oat", "", "5");
  ("hw5programs/run11.oat", "", "7");
  ("hw5programs/run14.oat", "", "16");
  ("hw5programs/run15.oat", "", "19");
  ("hw5programs/run16.oat", "", "13");
  ("hw5programs/run22.oat", "", "abc0");
  ("hw5programs/run23.oat", "", "1230");
  ("hw5programs/run25.oat", "", "nnn0");
  ("hw5programs/run46.oat", "", "420");
  ("hw5programs/run47.oat", "", "3");
  ("hw5programs/run48.oat", "", "11");
  ("hw5programs/lib4.oat", "", "53220");
  ("hw5programs/lib5.oat", "", "20");
  ("hw5programs/lib6.oat", "", "56553");
  ("hw5programs/lib7.oat", "", "53");
  ("hw5programs/lib8.oat", "", "Hello world!0");
  ("hw5programs/lib9.oat", "a b c d", "abcd5");
  ("hw5programs/lib11.oat", "", "45");
  ("hw5programs/lib14.oat", "", "~}|{zyxwvu0");
  ("hw5programs/lib15.oat", "123456789", "456780");
  ("hw5programs/regalloctest.oat", "", "0");
  ("hw5programs/regalloctest2.oat", "", "137999986200000000")  
]

let hw5_hard_tests = [
("hw5programs/fac.oat", "", "120");
("hw5programs/bsort.oat", "", "y}xotnuw notuwxy}255");
("hw5programs/msort.oat", "", "~}|{zyxwvu uvwxyz{|}~ 0");
("hw5programs/msort2.oat", "", "~}|{zyxwvu uvwxyz{|}~ 0");
("hw5programs/selectionsort.oat", "", "01253065992000");
("hw5programs/matrixmult.oat", "", "19 16 13 23 \t5 6 7 6 \t19 16 13 23 \t5 6 7 6 \t0");
]

let hw5_old_student_tests = [
    ("hw5programs/binary_search.oat", "", "Correct!0")
  ; ("hw5programs/xor_shift.oat", "", "838867572\n22817190600")
  ; ("hw5programs/sieve.oat", "", "25")
  ; ("hw5programs/fibo.oat", "", "0")
  ; ("hw5programs/lfsr.oat", "", "TFTF FFTT0")
  ; ("hw5programs/gnomesort.oat", "", "01253065992000")
  ; ("hw5programs/josh_joyce_test.oat", "", "0")
  ; ("hw5programs/gcd.oat", "", "16")
  ; ("hw5programs/insertion_sort.oat", "", "42")
  ; ("hw5programs/maxsubsequence.oat", "", "107")
]

let struct_tests = [
("hw7programs/compile_assign_struct.oat", "", "16");
("hw7programs/compile_basic_struct.oat", "", "7");
("hw7programs/compile_global_struct.oat", "", "254");
("hw7programs/compile_nested_struct.oat", "", "10");
("hw7programs/compile_return_struct.oat", "", "0");
("hw7programs/compile_struct_array.oat", "", "15");
("hw7programs/compile_struct_fptr.oat", "", "7");
("hw7programs/compile_various_fields.oat", "", "hello253"); 
]

let fptr_tests = [
  ("hw7programs/compile_array_fptr.oat", "", "2");
  ("hw7programs/compile_func_argument.oat", "", "4");
  ("hw7programs/compile_scall_fptr.oat", "", "4");
  (* This one test case yields identical results for our reference solution for
     "greedy" and "better" register allocation.  (It is too short to benefit
     from smart allocation.)  *)
  (* ("hw7programs/compile_var_fptr.oat", "", "1"); *)
  ("hw7programs/compile_local_fptr.oat", "", "5");
  ("hw7programs/compile_function_shadow.oat", "", "12");
  ("hw7programs/compile_builtin_argument.oat", "", "abab0");    
]

let regalloc_challenge_tests = [
 ("hw5programs/arrayargs3.oat", "", "34");
 ("hw5programs/run41.oat", "", "3");
 ("hw5programs/run51.oat", "", "341");
 ("hw5programs/run52.oat", "", "15");
 ("hw5programs/run54.oat", "", "10");
 ("hw5programs/run55.oat", "", "6");    
 ("hw5programs/qsort.oat", "", "kpyf{shomfhkmopsy{255");
 ("hw5programs/count_sort.oat", "", "AFHZAAEYC\nAAACEFHYZ0");
]

let new_tests = [
  ("hw7programs/ifq1.oat", "", "4");
  ("hw7programs/length2.oat", "", "3");  
  ("hw7programs/initarr1.oat", "", "1");
  ("hw7programs/initarr2.oat", "", "2");
]
